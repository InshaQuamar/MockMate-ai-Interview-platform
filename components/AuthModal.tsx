...
const AuthModal: React.FC<AuthModalProps> = ({ isOpen, onClose }) => {
  ...
  const handleSimulatedLogin = async (type: 'google' | 'manual') => {
    ...
    const mockUser = {
      ...
      email: type === 'google' ? "insha@google.com" : "guest@interviewace.iq",
      avatar: type === 'google' 
      ...
      <div className="relative w-full max-w-md glass border border-white/10 rounded-[2.5rem] shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-300">
        <div className="p-8 md:p-10 space-y-8">
          <div className="text-center space-y-2">
            <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl flex items-center justify-center text-white font-black shadow-xl shadow-blue-500/20 italic tracking-tighter text-2xl mx-auto mb-4">
              IQ
            </div>
